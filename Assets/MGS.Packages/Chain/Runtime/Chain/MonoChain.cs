...
namespace MGS.Chain
{
    ...
    public abstract class MonoChain : MonoBehaviour, IChain
    {
        ...
        protected void AddNodeToLast()
        {
            ...
            //nodeClone.transform.localScale = nodeClone.transform.localScale*( transform.localScale.x);
            /* GameObject nodeClone = Instantiate(nodePrefab, transform.position, transform.rotation, transform);
             nodeClone.transform.localScale = transform.localScale;*/
