...
public class SecondCircle : MonoBehaviour, IPointerEnterHandler, IBeginDragHandler, IEndDragHandler, IDragHandler
{
    public static SecondCircle Instance { get; private set; }
    public event EventHandler Event_OnCircleZero;
    public event EventHandler Event_OnCircleNotZero;
    public event EventHandler Event_OnSecondCircleEnd;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
            ...
            this.GetComponent<RectTransform>().rotation.eulerAngles.z < 360 + offset && this.GetComponent<RectTransform>().rotation.eulerAngles.z > 360 - offset))
        {
            ...
            Event_OnSecondCircleEnd?.Invoke(this, EventArgs.Empty);
        }
    }
    ...
    {
        //Debug.Log("OnDrag");
        if (isDragging && secondCircleRotate && !solved)
        {
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        if (transform.name == "SecondCircle")
        {
