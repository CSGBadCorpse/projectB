...
public class BrokenBricks : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            currentTime = 0;
            Shader.SetGlobalVector("_playerDistance", new Vector4(0, 0, 0, 0));
            Shader.SetGlobalVector("_playerDistance_1", new Vector4(0, 0, 0, 0));
            Shader.SetGlobalVector("_playerDistance_2", new Vector4(0, 0, 0, 0));
